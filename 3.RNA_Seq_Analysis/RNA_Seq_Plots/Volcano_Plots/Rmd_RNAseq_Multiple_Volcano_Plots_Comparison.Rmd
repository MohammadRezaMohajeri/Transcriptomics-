...
params:
  data_path: "countMatrix.tsv" # Default path for local rendering, will be overwritten by GitHub Actions.
  meta_path: "metadata.tsv"    # Default path for local rendering, will be overwritten by GitHub Actions.
---
