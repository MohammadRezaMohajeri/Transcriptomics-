...
p <- read.table(gzfile("Transcriptomics-/3.RNA_Seq_Analysis/1.GEO_RNASeq_CountMatrix_Extraction/Data/GSM3998274_245-Ann-Daly_S13.counts.txt.gz"), sep="\t", header = TRUE, row.names = 1)
...
allGSMFiles <- list.files("Transcriptomics-/3.RNA_Seq_Analysis/1.GEO_RNASeq_CountMatrix_Extraction/Data/", pattern="^GSM", full.names=TRUE)
